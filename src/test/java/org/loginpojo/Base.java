...
public class Base {
	...
	public static void takeScreenShot(String s) throws IOException {
        ...
        File f=new File("C:\\Users\\Dell\\eclipse-workspace\\MavenProject\\TakeScreenshot\\"+s+".png");
    ...
    public static String getDriven(int rowNo,int cellNo,String sheetName) throws IOException {
		File f=new File("C:\\Users\\Kayira\\eclipse-workspace\\CucumberTask\\Excel\\Facebooklogin.xlsx");
